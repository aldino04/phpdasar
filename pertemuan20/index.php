...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <!-- Spiner -->
        <div class="spinner-border text-light mr-3 spinner-border-sm" role="status" id="loader">
        ...
        <button id="tombol-cari" class="btn btn-outline-light my-2 my-sm-0" type="submit" name="cari">Search</button>
    ...
    <strong>INI NOTE !!</strong> Pertemuan 20 Menambahkan Live Search Dengan AJAX jQuery
